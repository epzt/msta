...
class Ui_setGSTATrendCaseDialog(object):
    def setupUi(self, setGSTATrendCaseDialog):
        ...
        self.buttonRemoveGSTATrendCase.setGeometry(QtCore.QRect(100, 130, 41, 27))
        ...
        self.buttonAddGSTATrendCase.setGeometry(QtCore.QRect(100, 80, 41, 27))
        ...
        self.GSTATrendMeanGroup.setGeometry(QtCore.QRect(150, 29, 181, 51))
        ...
        self.GSTATrendSortingGroup.setGeometry(QtCore.QRect(150, 90, 181, 51))
        ...
        self.GSTATrendSkewnessGroup.setGeometry(QtCore.QRect(150, 150, 181, 51))
        ...
        self.labelTrendCase = QtWidgets.QLabel(self.GSTAGroup)
        self.labelTrendCase.setGeometry(QtCore.QRect(17, 40, 71, 161))
        self.labelTrendCase.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.labelTrendCase.setMouseTracking(False)
        self.labelTrendCase.setAutoFillBackground(True)
        self.labelTrendCase.setFrameShape(QtWidgets.QFrame.Panel)
        self.labelTrendCase.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.labelTrendCase.setText("")
        self.labelTrendCase.setScaledContents(False)
        self.labelTrendCase.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.labelTrendCase.setWordWrap(False)
        self.labelTrendCase.setTextInteractionFlags(QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        self.labelTrendCase.setObjectName("labelTrendCase")
        self.splitter = QtWidgets.QSplitter(self.GSTAGroup)
        self.splitter.setGeometry(QtCore.QRect(10, 210, 321, 24))
        ...
        self.labelTrendCase.raise_()
        self.linkOperandComboBox.raise_()
        self.label.raise_()
    ...
    def retranslateUi(self, setGSTATrendCaseDialog):
        ...
        self.label.setText(_translate("setGSTATrendCaseDialog", "Operand which link multiple trend cases"))
