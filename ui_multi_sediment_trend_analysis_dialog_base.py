...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuTrends = QtWidgets.QMenu(self.menuExpressions)
        self.menuTrends.setObjectName("menuTrends")
        self.menuGSTA_trends = QtWidgets.QMenu(self.menuExpressions)
        self.menuGSTA_trends.setObjectName("menuGSTA_trends")
        ...
        self.actionDeleteTrends = QtWidgets.QAction(MainWindow)
        self.actionDeleteTrends.setObjectName("actionDeleteTrends")
        ...
        self.actionDeleteGSTATrends = QtWidgets.QAction(MainWindow)
        self.actionDeleteGSTATrends.setObjectName("actionDeleteGSTATrends")
        self.actionListGSTATrend = QtWidgets.QAction(MainWindow)
        self.actionListGSTATrend.setObjectName("actionListGSTATrend")
        self.actionAllDeleteTrends = QtWidgets.QAction(MainWindow)
        self.actionAllDeleteTrends.setObjectName("actionAllDeleteTrends")
        ...
        self.menuGSTA_trends.addAction(self.actionSetGSTATrend)
        self.menuGSTA_trends.addAction(self.actionListGSTATrend)
        self.menuExpressions.addAction(self.menuTrends.menuAction())
        self.menuExpressions.addAction(self.menuGSTA_trends.menuAction())
        self.menuExpressions.addAction(self.actionAllDeleteTrends)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuGSTA_trends.setTitle(_translate("MainWindow", "GSTA trends..."))
        ...
        self.actionDeleteTrends.setText(_translate("MainWindow", "Delete all"))
        ...
        self.actionSetGSTATrend.setText(_translate("MainWindow", "Set/modify"))
        self.actionDeleteGSTATrends.setText(_translate("MainWindow", "Delete all"))
        self.actionListGSTATrend.setText(_translate("MainWindow", "List"))
        self.actionAllDeleteTrends.setText(_translate("MainWindow", "Delete all trends"))
