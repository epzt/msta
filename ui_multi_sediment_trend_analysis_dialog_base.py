...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuExpressions.addAction(self.actionSetTrend)
        self.menuExpressions.addAction(self.actionSetGSTATrend)
        self.menuExpressions.addAction(self.actionListTrend)
        self.menuExpressions.addAction(self.actionDeleteTrend)
